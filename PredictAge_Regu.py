...
train = model2.fit_generator(generator=train_data, steps_per_epoch=50, epochs=500, validation_data=val_data,
                             validation_steps=17, verbose=1, callbacks=my_callbacks)
# Lưu weights
model2.save_weights('weights_Regression_Data25k_(callbacks).h5')
